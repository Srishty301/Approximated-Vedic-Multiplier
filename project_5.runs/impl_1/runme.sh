...
HD_PWD='C:/Users/srish/project_5/project_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log approx_vedic_4_x_4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source approx_vedic_4_x_4.tcl -notrace
