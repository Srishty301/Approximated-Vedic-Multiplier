...
HD_PWD='C:/Users/srish/project_5/project_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log approx_vedic_4_x_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source approx_vedic_4_x_4.tcl
